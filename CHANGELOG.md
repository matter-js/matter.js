...
- @matter/testing
    ...
    - Enhancement: The certification controller test CI workflow gained a leg driving the suite with chip-tool as the controller against the in-process matterjs device

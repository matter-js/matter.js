...
- @matter/protocol
    ...
    - Fix: A BLE discovery that ends no longer stops the scan another discovery still needs; `BleScanner` scans from the first discovery until the last one ends

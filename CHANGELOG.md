...
- @matter/protocol
    ...
    - Fix: Validate the OTA image digest algorithm when reading an image (rejecting unknown identifiers) and support all FIPS digest algorithms consistently across the read and extract paths

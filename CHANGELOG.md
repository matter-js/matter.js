...
- @matter/protocol
    ...
    - Enhancement: `BdxSession` reports the `*Init` that opened it and the parameters its transfer settled on, so a responder's own account of what it granted is readable without decoding the wire

...
- @matter/node
    ...
    - Adjustment: Because we saw devices in the wild that needed up to 2 minutes to answer to MDNS queries we increase the discovery time for commissioning targets to 3 minutes (was 1 minute before)

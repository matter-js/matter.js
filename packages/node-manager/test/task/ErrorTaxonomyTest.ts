...
const CODES: Array<[TaskRefusedError, TaskFindingCode]> = [
    ...
    [new TaskNoLongerTrackedError(""), TaskFindingCode.NoLongerTracked],
    [new TaskParamsRejectedError(""), TaskFindingCode.ParamsRejected],
    [new TaskTypeNotRegisteredError(""), TaskFindingCode.TypeNotRegistered],
    [new TaskNotRollbackableError(""), TaskFindingCode.NotRollbackable],
    [new TaskManagerClosingError(""), TaskFindingCode.ManagerClosing],
    [new TaskOutcomeUnrecordedError(""), TaskFindingCode.OutcomeUnrecorded],
    ...
    [new TaskForeignFabricError(""), TaskFindingCode.ForeignFabric],
    [new TaskNoManagedFabricError(""), TaskFindingCode.NoManagedFabric],
];

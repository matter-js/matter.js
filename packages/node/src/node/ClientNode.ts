 ...
 *
 * A node's `id` names it locally and may be reissued after the node is removed.  Persist a {@link PeerAddress} for
 * anything that has to name the same physical device again later.
 */

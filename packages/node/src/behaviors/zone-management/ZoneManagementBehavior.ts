...
import { ZoneManagementInterface } from "./ZoneManagementInterface.js";
 ...
 */
export const ZoneManagementBehaviorConstructor = ClusterBehavior
    .withInterface<ZoneManagementInterface>()
    .for(ZoneManagement.Cluster);

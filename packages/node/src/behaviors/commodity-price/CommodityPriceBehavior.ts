...
import { CommodityPriceInterface } from "./CommodityPriceInterface.js";
 ...
 */
export const CommodityPriceBehaviorConstructor = ClusterBehavior
    .withInterface<CommodityPriceInterface>()
    .for(CommodityPrice.Cluster);

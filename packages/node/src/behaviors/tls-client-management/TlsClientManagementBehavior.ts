...
import { TlsClientManagementInterface } from "./TlsClientManagementInterface.js";
 ...
 */
export const TlsClientManagementBehaviorConstructor = ClusterBehavior
    .withInterface<TlsClientManagementInterface>()
    .for(TlsClientManagement.Cluster);

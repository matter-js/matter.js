...
import { CommodityTariffInterface } from "./CommodityTariffInterface.js";
 ...
 */
export const CommodityTariffBehaviorConstructor = ClusterBehavior
    .withInterface<CommodityTariffInterface>()
    .for(ClusterType(CommodityTariff.Base));

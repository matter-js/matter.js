...
import { ClosureDimensionInterface } from "./ClosureDimensionInterface.js";
 ...
 */
export const ClosureDimensionBehaviorConstructor = ClusterBehavior
    .withInterface<ClosureDimensionInterface>()
    .for(ClusterType(ClosureDimension.Base));

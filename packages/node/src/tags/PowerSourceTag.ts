 ...
 *
 * @see {@link MatterSpecification.v16.Namespace} § 14
 */
export const PowerSourceTag = SemanticNamespace({
    ...
    tags: {
         ...
         *
         * @see {@link MatterSpecification.v16.Namespace} § 14.1
         */
         ...
         * Power Source clusters with this tag shall implement the WIRED feature.
         *
         * @see {@link MatterSpecification.v16.Namespace} § 14.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Namespace} § 14.3
         */
         ...
         * Power Source clusters with this tag shall implement the BAT feature.
         *
         * @see {@link MatterSpecification.v16.Namespace} § 14.4
         */
        Ev: { id: 0x4, label: "Ev" }
    }
});

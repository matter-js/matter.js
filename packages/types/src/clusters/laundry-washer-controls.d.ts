 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 8.6
 */
export declare namespace LaundryWasherControls {
    ...
    export interface SpinAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.6.6.1
         */
        spinSpeeds: string[];
         ...
         * current mode.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.6.6.2
         */
    ...
    export interface RinseAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.6.6.3
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.6.6.4
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 8.6.4
     */
    export enum Feature {
        /**
         * Spin (SPIN)
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.6.4.1
         */
        Spin = "Spin",
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.6.4.2
         */
        Rinse = "Rinse"
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 8.6.5.1
     */

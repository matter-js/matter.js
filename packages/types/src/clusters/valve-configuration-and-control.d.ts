 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 4.6
 */
export declare namespace ValveConfigurationAndControl {
    ...
    export interface BaseAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.7.1
         */
         ...
         * by the user or some other automation.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.7.2
         */
         ...
         * Close command.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.7.4
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.7.5
         */
         ...
         * failed.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.7.6
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.7.10
         */
    ...
    export interface TimeSyncAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.7.3
         */
    ...
    export interface LevelAttributes {
         ...
         * A value of null shall indicate that the current state is not known.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.7.7
         */
         ...
         * failed.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.7.8
         */
         ...
         * returned.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.7.9
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.7.11
         */
        levelStep?: number;
    }
    ...
    export interface BaseCommands {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.8.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.8.2
         */
        close(): MaybePromise;
    }
    ...
    export interface BaseEvents {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.9.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.9.2
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 4.6.4
     */
    export enum Feature {
        /**
         * TimeSync (TS)
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.4.1
         */
        TimeSync = "TimeSync",
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.4.2
         */
        Level = "Level"
    }

    /**
     * @see {@link MatterSpecification.v16.Cluster} § 4.6.5.2
     */
    ...
    /**
     * @see {@link MatterSpecification.v16.Cluster} § 4.6.5.1
     */
    ...
    export class OpenRequest {
         ...
         * by the user or some other automation.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.8.1.1
         */
        openDuration?: number | null;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.8.1.2
         */
        targetLevel?: number;
    }
    ...
    export class ValveStateChangedEvent {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.9.1.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.9.1.2
         */
        valveLevel?: number;
    }
    ...
    export class ValveFaultEvent {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 4.6.9.2.1
         */
        valveFault: ValveFault;
    }

    /**
     * @see {@link MatterSpecification.v16.Cluster} § 4.6.6.1
     */

 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 8.2
 */
export declare namespace TemperatureControl {
    ...
    export interface TemperatureNumberAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.2.5.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.2.5.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.2.5.3
         */
    ...
    export interface TemperatureStepAttributes {
         ...
         *   (2650), etc.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.2.5.4
         */
        step: number;
    }
    ...
    export interface TemperatureLevelAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.2.5.5
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.2.5.6
         */
    ...
    export interface BaseCommands {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.2.6.1
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 8.2.4
     */
    export enum Feature {
        /**
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.2.4.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.2.4.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.2.4.3
         */
    ...
    export class SetTemperatureRequest {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.2.6.1.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.2.6.1.2
         */

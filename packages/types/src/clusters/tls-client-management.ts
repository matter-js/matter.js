...
export namespace TlsClientManagement {
    ...
    export const TlvTlsEndpoint = TlvObject({
         ...
         */
        hostname: TlvField(1, TlvByteString.bound({ minLength: 4, maxLength: 253 })),
         ...
         */
        port: TlvField(2, TlvUInt16.bound({ min: 1 })),
         ...
         */
        caid: TlvField(3, TlvUInt16.bound({ min: 0, max: 65534 })),
         ...
         */
        ccdid: TlvField(4, TlvNullable(TlvUInt16)),
         ...
         */
        referenceCount: TlvField(5, TlvUInt8),
     ...
     * @see {@link MatterSpecification.v142.Core} § 14.5.4.2
     */
    export interface TlsEndpoint extends TypeFromSchema<typeof TlvTlsEndpoint> {}

    /**
     * Input to the TlsClientManagement provisionEndpoint command
     *
     * @see {@link MatterSpecification.v142.Core} § 14.5.7.1
     */
    export const TlvProvisionEndpointRequest = TlvObject({
        /**
         * This field shall represent a TLS Hostname.
         *
         * @see {@link MatterSpecification.v142.Core} § 14.5.7.1.1
         */
        hostname: TlvField(0, TlvByteString.bound({ minLength: 4, maxLength: 253 })),
         ...
         */
        port: TlvField(1, TlvUInt16.bound({ min: 1 })),
         ...
         */
        caid: TlvField(2, TlvUInt16.bound({ min: 0, max: 65534 })),
         ...
         */
        ccdid: TlvField(3, TlvNullable(TlvUInt16)),
         ...
         */
        endpointId: TlvField(4, TlvNullable(TlvUInt16))
    });
     ...
     * @see {@link MatterSpecification.v142.Core} § 14.5.7.1
     */
    export interface ProvisionEndpointRequest extends TypeFromSchema<typeof TlvProvisionEndpointRequest> {}
     ...
     */
    export const TlvProvisionEndpointResponse = TlvObject({
        /**
     ...
     * @see {@link MatterSpecification.v142.Core} § 14.5.7.2
     */
    export interface ProvisionEndpointResponse extends TypeFromSchema<typeof TlvProvisionEndpointResponse> {}

    /**
     * Input to the TlsClientManagement findEndpoint command
     *
     * @see {@link MatterSpecification.v142.Core} § 14.5.7.3
     */
    export const TlvFindEndpointRequest = TlvObject({
        /**
     ...
     * @see {@link MatterSpecification.v142.Core} § 14.5.7.3
     */
    export interface FindEndpointRequest extends TypeFromSchema<typeof TlvFindEndpointRequest> {}
     ...
     * @see {@link MatterSpecification.v142.Core} § 14.5.7.4
     */
    export interface FindEndpointResponse extends TypeFromSchema<typeof TlvFindEndpointResponse> {}

    /**
     * Input to the TlsClientManagement removeEndpoint command
     *
     * @see {@link MatterSpecification.v142.Core} § 14.5.7.5
     */
    export const TlvRemoveEndpointRequest = TlvObject({
        /**
     ...
     * @see {@link MatterSpecification.v142.Core} § 14.5.7.5
     */
    export interface RemoveEndpointRequest extends TypeFromSchema<typeof TlvRemoveEndpointRequest> {}
    ...
    export class EndpointAlreadyInstalledError extends StatusResponseError {
        constructor(
            message = "The endpoint is already installed",
            code = Status.Failure,
            clusterCode = StatusCode.EndpointAlreadyInstalled
        ) {
    ...
    export class RootCertificateNotFoundError extends StatusResponseError {
        constructor(
            message = "No root certificate exists for this CAID",
            code = Status.Failure,
            clusterCode = StatusCode.RootCertificateNotFound
        ) {
            super(message, code, clusterCode);
        }
    }
    ...
    export class ClientCertificateNotFoundError extends StatusResponseError {
        constructor(
            message = "No client certificate exists for this CCDID",
            code = Status.Failure,
            clusterCode = StatusCode.ClientCertificateNotFound
        ) {
            super(message, code, clusterCode);
        }
    }
    ...
    export class EndpointInUseError extends StatusResponseError {
        constructor(
            message = "The endpoint is in use and cannot be removed",
            code = Status.Failure,
            clusterCode = StatusCode.EndpointInUse
        ) {
            super(message, code, clusterCode);
        }
    }
    ...
    export class InvalidTimeError extends StatusResponseError {
        constructor(
            message = "Time sync has not yet occurred",
            code = Status.Failure,
    ...
    export const ClusterInstance = MutableCluster({
        ...
        attributes: {
             ...
             */
            maxProvisioned: FixedAttribute(0x0, TlvUInt8.bound({ min: 5, max: 254 })),

            /**
             * Indicates a list of currently provisioned TLS Endpoints on this Node. The maximum length of this list
             * when read will be the value of MaxProvisioned.
             *
             * @see {@link MatterSpecification.v142.Core} § 14.5.6.2
             */
            provisionedEndpoints: FabricScopedAttribute(
                0x1,
                TlvArray(TlvTlsEndpoint),
        ...
        commands: {
             ...
             * @see {@link MatterSpecification.v142.Core} § 14.5.7.1
             */
            provisionEndpoint: Command(
                0x0,
                TlvProvisionEndpointRequest,
                0x1,
                TlvProvisionEndpointResponse,
             ...
             * @see {@link MatterSpecification.v142.Core} § 14.5.7.3
             */
            findEndpoint: Command(0x2, TlvFindEndpointRequest, 0x3, TlvFindEndpointResponse),
             ...
             * @see {@link MatterSpecification.v142.Core} § 14.5.7.5
             */
            removeEndpoint: Command(
                0x4,
                TlvRemoveEndpointRequest,
                0x4,
                TlvNoResponse,
                { invokeAcl: AccessLevel.Administer }
            )
...
export type TlsClientManagementCluster = TlsClientManagement.Cluster;
export const TlsClientManagementCluster = TlsClientManagement.Cluster;
ClusterRegistry.register(TlsClientManagement.Complete);

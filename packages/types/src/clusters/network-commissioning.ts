...
export namespace NetworkCommissioning {
    ...
    export const WiFiNetworkInterfaceOrThreadNetworkInterfaceComponent = MutableCluster.Component({
        ...
        commands: {
             ...
             * configuration if the CommissioningComplete command (see Section 11.10.7.6, “CommissioningComplete”) is
             ...
             * shall be followed. Once the commissioning channel is closed, if the attribute IsCommissioningWithoutPower
             * is absent or false, the operational channel shall start without waiting. However, if
             * IsCommissioningWithoutPower is true, the operational channel shall start automatically as soon as the
             * device is powered up and running. It is possible that the only method to determine success of the
             * operation is operational discovery of the Node on the new operational network. Therefore, before invoking
             * the ConnectNetwork command, the client SHOULD re-invoke the Arm Fail-Safe command with a duration that
             * meets the following:
             *
    ...
    export const WiFiNetworkInterfaceComponent = MutableCluster.Component({
        ...
        commands: {
             ...
             * not appear in the Section 11.9.6.2, “Networks” attribute, for security reasons.
             *
             * If this command contains a ClientIdentifier, and the Section 11.9.6.2, “Networks” list does not contain
             * an entry with a matching ClientIdentifier, then this command shall fail with a status of NOT_FOUND.
             *

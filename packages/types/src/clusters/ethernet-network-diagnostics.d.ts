 ...
 *
 * @see {@link MatterSpecification.v16.Core} § 11.16
 */
export declare namespace EthernetNetworkDiagnostics {
    ...
    export interface BaseAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 11.16.6.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 11.16.6.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 11.16.6.8
         */
         ...
         * for any reason.
         *
         * @see {@link MatterSpecification.v16.Core} § 11.16.6.9
         */
    ...
    export interface PacketCountsAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 11.16.6.3
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 11.16.6.4
         */
    ...
    export interface ErrorCountsAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 11.16.6.5
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 11.16.6.6
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 11.16.6.7
         */
    ...
    export interface PacketCountsOrErrorCountsCommands {
         ...
         *   - OverrunCount
         *
         * @see {@link MatterSpecification.v16.Core} § 11.16.7.1
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Core} § 11.16.4
     */
    export enum Feature {
        /**
         * PacketCounts (PKTCNT)
    ...
    /**
     * @see {@link MatterSpecification.v16.Core} § 11.16.5.1
     */
    export enum PhyRate {
        /**
         * PHY rate is 10Mbps

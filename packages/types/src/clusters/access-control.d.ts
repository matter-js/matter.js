...
export declare namespace AccessControl {
    ...
    export interface BaseAttributes {
        ...
        /**
         * Indicates the minimum number of Subjects per entry that are supported by this server.
         *
        ...
        /**
         * Indicates the minimum number of Targets per entry that are supported by this server.
         *
         * Since reducing this value over time may invalidate ACL entries already written, this value shall NOT decrease
         * across time as software updates occur that could impact this value. If this is a concern for a given
         * implementation, it is recommended to only use the minimum value required and avoid reporting a higher value
        ...
        /**
         * Indicates the minimum number of ACL Entries per fabric that are supported by this server.
         *
         * Since reducing this value over time may invalidate ACL entries already written, this value shall NOT decrease
         * across time as software updates occur that could impact this value. If this is a concern for a given
         * implementation, it is recommended to only use the minimum value required and avoid reporting a higher value
    ...
    export interface ExtensionAttributes {
        /**
         * Indicates a list of additional data, related to the fabric's Access Control Entries.
         *
         * The Access Control Extensions may be used by Administrators to store arbitrary data related to fabric's
    ...
    export interface ManagedDeviceAttributes {
        /**
         * Indicates the set of CommissioningAccessRestrictionEntryStruct applied during commissioning on a managed
         * device.
         *
    ...
    export interface AuxiliaryAttributes {
        /**
         * Indicates a list of additional ACL entries generated by the server that shall be applied during the Access
         * Control Privilege Granting algorithm. These ACL entries are not writable or removable using this attribute;
         * they reflect the underlying feature that generated them.
         *

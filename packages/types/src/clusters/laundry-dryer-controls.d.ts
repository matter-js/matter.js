 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 8.9
 */
export declare namespace LaundryDryerControls {
    ...
    export interface BaseAttributes {
         ...
         * Laundry Dryer mode.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.9.5.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.9.5.2
         */
     ...
     * temperature level.
     *
     * @see {@link MatterSpecification.v16.Cluster} § 8.9.4.1
     */

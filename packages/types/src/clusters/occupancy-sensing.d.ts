 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 2.7
 */
export declare namespace OccupancySensing {
    ...
    export interface BaseAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.7.6.1
         */
        occupancy: Occupancy;

        /**
         * @see {@link MatterSpecification.v16.Cluster} § 2.7.6
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.7.6.4
         */
    ...
    export interface BaseEvents {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.7.7.1
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 2.7.4
     */
    export enum Feature {
        /**
         * Other (OTHER)
    ...
    /**
     * @see {@link MatterSpecification.v16.Cluster} § 2.7.5.1
     */
    export class Occupancy {
         ...
         * unoccupied state.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.7.5.1.1
         */
        occupied?: boolean;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 2.7.5.3
     */
     ...
     *   provide the sensor modality (or modalities) for later cluster revisions. See Backward Compatibility section.
     *
     * @see {@link MatterSpecification.v16.Cluster} § 2.7.5.2
     */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 2.7.5.4
     */
    export class HoldTimeLimits {
         ...
         * seconds.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.7.5.4.1
         */
        holdTimeMin: number;
         ...
         * seconds.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.7.5.4.2
         */
        holdTimeMax: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.7.5.4.3
         */
    ...
    export class OccupancyChangedEvent {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.7.7.1.1
         */
        occupancy: Occupancy;
    }

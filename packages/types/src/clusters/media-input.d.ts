 ...
 * device.
 *
 * @see {@link MatterSpecification.v16.Cluster} § 6.9
 */
export declare namespace MediaInput {
    ...
    export interface BaseAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 6.9.6.1
         */
        inputList: InputInfo[];
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 6.9.6.2
         */
        currentInput: number;
    }
    ...
    export interface BaseCommands {
         ...
         * Input List.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 6.9.7.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 6.9.7.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 6.9.7.3
         */
    ...
    export interface NameUpdatesCommands {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 6.9.7.4
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 6.9.4
     */
    export enum Feature {
        /**
         * NameUpdates (NU)
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 6.9.5.2
     */
    export class InputInfo {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 6.9.5.2.1
         */
        index: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 6.9.5.2.2
         */
        inputType: InputType;
         ...
         * when known.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 6.9.5.2.3
         */
        name: string;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 6.9.5.2.4
         */
        description: string;
    }
    ...
    export class SelectInputRequest {
         ...
         * change to.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 6.9.7.1.1
         */
        index: number;
    }
    ...
    /**
     * @see {@link MatterSpecification.v16.Cluster} § 6.9.5.1
     */

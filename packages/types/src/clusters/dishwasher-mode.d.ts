 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 8.3
 */
export declare namespace DishwasherMode {
    ...
    export interface BaseAttributes {
         ...
         * list.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.3.6.1
         */
        supportedModes: ModeOption[];

        /**
         * @see {@link MatterSpecification.v16.Cluster} § 8.3.6
         */
        currentMode: number;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 8.3.4
     */
    export enum Feature {
        /**
         * OnOff (DEPONOFF)
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 8.3.5.1
     */
    ...
    export enum ModeTag {
        /**
         * @see {@link MatterSpecification.v16.Cluster} § 8.3.7.1
         */
        Auto = 0,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.3.7.1.1
         */
        Normal = 16384,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.3.7.1.2
         */
        Heavy = 16385,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.3.7.1.3
         */
        Light = 16386
    }

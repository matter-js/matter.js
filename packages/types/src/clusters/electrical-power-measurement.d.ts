 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 2.13
 */
export declare namespace ElectricalPowerMeasurement {
    ...
    export interface BaseAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.6.9
         */
         ...
         * shall NOT delay marking this attribute as ready for report for longer than 60 seconds.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.6.4
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.6.5
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.6.6
         */
    ...
    export interface AlternatingCurrentAttributes {
         ...
         * If the current cannot be measured, a value of null shall be returned.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.6.7
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.6.8
         */
         ...
         * exported.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.6.10
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.6.11
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.6.12
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.6.13
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.6.14
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.6.15
         */
         ...
         * shall NOT delay marking this attribute as ready for report for longer than 60 seconds.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.6.18
         */
    ...
    export interface HarmonicsAttributes {
         ...
         * shall NOT delay marking this attribute as ready for report for longer than 60 seconds.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.6.16
         */
    ...
    export interface PowerQualityAttributes {
         ...
         * shall NOT delay marking this attribute as ready for report for longer than 60 seconds.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.6.17
         */
    ...
    export interface PolyphasePowerAttributes {
         ...
         * shall NOT delay marking this attribute as ready for report for longer than 60 seconds.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.6.19
         */
    ...
    export interface BaseEvents {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.7.1
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 2.13.4
     */
    export enum Feature {
        /**
         * DirectCurrent (DIRC)
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.4.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.4.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.4.3
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.4.4
         */
        Harmonics = "Harmonics",
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.4.5
         */
        PowerQuality = "PowerQuality"
    }

    /**
     * @see {@link MatterSpecification.v16.Cluster} § 2.13.5.1
     */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 2.13.5.3
     */
    export class MeasurementRange {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.5.3.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.5.3.2
         */
        min: number | bigint;
         ...
         * StartTimestamp and EndTimestamp or the period between StartSystime and EndSystime, or both.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.5.3.3
         */
        max: number | bigint;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.5.3.4
         */
         ...
         * does not have the capability of determining the time in UTC, this field shall be omitted.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.5.3.5
         */
        endTimestamp?: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.5.3.6
         */
        minTimestamp?: number;
         ...
         * This field shall be less than or equal to the value of the EndTimestamp field.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.5.3.7
         */
        maxTimestamp?: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.5.3.8
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.5.3.9
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.5.3.10
         */
         ...
         * This field shall be less than or equal to the value of the EndSystime field.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.5.3.11
         */
        maxSystime?: number | bigint;
    }

    /**
     * @see {@link MatterSpecification.v16.Cluster} § 2.13.5.4
     */
    export class HarmonicMeasurement {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.5.4.1
         */
        order: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.5.4.2
         */
    ...
    export class MeasurementPeriodRangesEvent {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.13.7.1.1
         */
        ranges: MeasurementRange[];
    }

    /**
     * @see {@link MatterSpecification.v16.Cluster} § 2.13.5.2
     */

...
export declare namespace PushAvStreamTransport {
    ...
    export interface BaseCommands {
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.10.3
         */
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.10.4
         */
         ...
         * all transports.
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.10.5
         */
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.10.6
         */
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.10.7
         */
    ...
    export interface BaseEvents {
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.11.1
         */
         ...
         * The data on this event shall contain the following information.
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.11.2
         */
     ...
     *
     * @see {@link MatterSpecification.v142.Cluster} § 11.7.6
     */
    export enum Feature {
        /**
     ...
     * a transport.
     *
     * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.6
     */
    export declare class SupportedFormat {
         ...
         * transport.
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.6.1
         */
         ...
         * transport.
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.6.2
         */
     ...
     *
     * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.16
     */
    export declare class TransportConfiguration {
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.16.1
         */
        connectionId: number;
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.16.2
         */
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.16.3
         */
    ...
    export declare class DeallocatePushTransportRequest {
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.10.3.1
         */
        connectionId: number;
    };
    ...
    export declare class ModifyPushTransportRequest {
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.10.4.1
         */
        connectionId: number;
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.10.4.2
         */
        transportOptions: TransportOptions;
    };
    ...
    export declare class SetTransportStatusRequest {
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.10.5.1
         */
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.10.5.2
         */
        transportStatus: TransportStatus;
    };
    ...
    export declare class ManuallyTriggerTransportRequest {
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.10.6.1
         */
        connectionId: number;
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.10.6.2
         */
         ...
         * shall be ignored.
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.10.6.3
         */
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.10.6.4
         */
        userDefined?: Bytes;
    };
    ...
    export declare class FindTransportRequest {
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.10.7.1
         */
        connectionId: number | null;
    };
     ...
     *
     * @see {@link MatterSpecification.v142.Cluster} § 11.7.10.8
     */
    export declare class FindTransportResponse {
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.10.8.1
         */
    ...
    export declare class PushTransportBeginEvent {
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.11.1.1
         */
        connectionId: number;
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.11.1.2
         */
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.11.1.3
         */
        activationReason?: TriggerActivationReason;
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.11.1.4
         */
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.11.1.5
         */
    ...
    export declare class PushTransportEndEvent {
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.11.2.1
         */
        connectionId: number;
         ...
         * This field shall indicate the container type chosen for this transport.
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.11.2.2
         */
        containerType?: ContainerFormat;
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.11.2.3
         */
        cmafSessionNumber?: number | bigint;
    };
    ...
    export enum TransportTriggerType {
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.1.1
         */
        Command = 0,
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.1.2
         */
        Motion = 1,
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.1.3
         */
        Continuous = 2
    }

    /**
     * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.2
     */
    ...
    /**
     * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.3
     */
    export enum ContainerFormat {
         ...
         * format.
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.3.1
         */
        Cmaf = 0
    }

    /**
     * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.4
     */
    export enum IngestMethods {
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.4.1
         */
        CmafIngest = 0
    }

    /**
     * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.5
     */
     ...
     *
     * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.7
     */
    export enum CmafInterface {
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.7.1
         */
        Interface1 = 0,
         ...
         * done.
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.7.2
         */
        Interface2Dash = 1,
         ...
         * done.
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.7.3
         */
        Interface2Hls = 2
    }
     ...
     *
     * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.8
     */
    export declare class VideoStream {
         ...
         * name.
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.8.1
         */
         ...
         * list to use.
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.8.2
         */
     ...
     * this becomes a CMAF Track.
     *
     * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.9
     */
    export declare class AudioStream {
         ...
         * name.
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.9.1
         */
         ...
         * list to use.
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.9.2
         */
     ...
     *
     * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.10
     */
    export declare class CmafContainerOptions {
         ...
         * Interfaces.
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.10.1
         */
         ...
         * seconds).
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.10.2
         */
         ...
         * resulting file.
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.10.3
         */
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.10.4
         */
        sessionGroup?: number;
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.10.5
         */
        trackName?: string;
         ...
         * encryption.
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.10.6
         */
        cencKey?: Bytes;
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.10.7
         */
        cencKeyId?: Bytes;
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.10.8
         */
     ...
     *
     * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.11
     */
    export declare class ContainerOptions {
         ...
         * This field shall indicate the container type chosen for this transport.
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.11.1
         */
        containerType: ContainerFormat;
         ...
         * shall be omitted.
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.11.2
         */
     ...
     *
     * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.12
     */
    export declare class TransportZoneOptions {
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.12.1
         */
        zone: number | null;
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.12.2
         */
        sensitivity?: number;
    };
     ...
     *
     * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.13
     */
    export declare class TransportTriggerOptions {
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.13.1
         */
        triggerType: TransportTriggerType;
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.13.2
         */
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.13.3
         */
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.13.4
         */
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.13.5
         */
     ...
     *
     * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.14
     */
    export declare class TransportMotionTriggerTimeControl {
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.14.1
         */
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.14.2
         */
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.14.3
         */
        maxDuration: number;
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.14.4
         */
     ...
     *
     * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.15
     */
    export declare class TransportOptions {
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.15.1
         */
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.15.2
         */
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.15.3
         */
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.15.4
         */
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.15.5
         */
        url: string;
         ...
         * options.
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.15.6
         */
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.15.7
         */
        ingestMethod: IngestMethods;
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.15.8
         */
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.15.9
         */
        expiryTime?: number;
         ...
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.15.10
         */
         ...
         * names for this transport.
         *
         * @see {@link MatterSpecification.v142.Cluster} § 11.7.7.15.11
         */

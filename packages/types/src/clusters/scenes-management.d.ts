 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 1.4
 */
export declare namespace ScenesManagement {
    ...
    export interface BaseAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.8.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.8.2
         */
    ...
    export interface BaseCommands {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.4
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.6
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.8
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.10
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.12
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.13
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.15
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 1.4.4
     */
    export enum Feature {
        /**
         * SceneNames (SN)
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.4.1
         */
        SceneNames = "SceneNames"
    }

    /**
     * @see {@link MatterSpecification.v16.Cluster} § 1.4.7.2
     */
    export class SceneInfo {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.7.2.1
         */
        sceneCount: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.7.2.2
         */
        currentScene: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.7.2.3
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.7.2.4
         */
        sceneValid: boolean;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.7.2.5
         */
    ...
    export class AddSceneRequest {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.2.1
         */
        groupId: GroupId;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.2.2
         */
        sceneId: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.2.3
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.2.4
         */
        sceneName: string;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.2.5
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.3
     */
    export class AddSceneResponse {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.3.1
         */
        status: Status;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.3.2
         */
        groupId: GroupId;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.3.3
         */
        sceneId: number;
    }
    ...
    export class ViewSceneRequest {
         ...
         * This field shall indicate the group identifier in the Group Table.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.4.1
         */
        groupId: GroupId;
         ...
         * This field shall indicate the scene identifier in the Scene Table.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.4.2
         */
        sceneId: number;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.5
     */
    export class ViewSceneResponse {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.5.1
         */
        status: Status;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.5.2
         */
        groupId: GroupId;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.5.3
         */
        sceneId: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.5.4
         */
        transitionTime?: number;
         ...
         * This field shall be set to the corresponding field in the Scene Table entry.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.5.5
         */
        sceneName?: string;
         ...
         * This field shall be set to the corresponding field in the Scene Table entry.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.5.6
         */
        extensionFieldSetStructs?: ExtensionFieldSet[];
    }
    ...
    export class RemoveSceneRequest {
         ...
         * This field shall indicate the group identifier in the Group Table.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.6.1
         */
        groupId: GroupId;
         ...
         * This field shall indicate the scene identifier in the Scene Table.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.6.2
         */
        sceneId: number;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.7
     */
    export class RemoveSceneResponse {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.7.1
         */
        status: Status;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.7.2
         */
        groupId: GroupId;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.7.3
         */
        sceneId: number;
    }
    ...
    export class RemoveAllScenesRequest {
         ...
         * This field shall indicate the group identifier in the Group Table.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.8.1
         */
        groupId: GroupId;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.9
     */
    export class RemoveAllScenesResponse {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.9.1
         */
        status: Status;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.9.2
         */
        groupId: GroupId;
    }
    ...
    export class StoreSceneRequest {
         ...
         * This field shall indicate the group identifier in the Group Table.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.10.1
         */
        groupId: GroupId;
         ...
         * This field shall indicate the scene identifier in the Scene Table.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.10.2
         */
        sceneId: number;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.11
     */
    export class StoreSceneResponse {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.11.1
         */
        status: Status;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.11.2
         */
        groupId: GroupId;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.11.3
         */
        sceneId: number;
    }
    ...
    export class RecallSceneRequest {
         ...
         * This field shall indicate the group identifier in the Group Table.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.12.1
         */
        groupId: GroupId;
         ...
         * This field shall indicate the scene identifier in the Scene Table.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.12.2
         */
        sceneId: number;
         ...
         * This field shall indicate the transition time of the scene, measured in milliseconds.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.12.3
         */
    ...
    export class GetSceneMembershipRequest {
         ...
         * This field shall indicate the group identifier in the Group Table.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.13.1
         */
        groupId: GroupId;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.14
     */
    export class GetSceneMembershipResponse {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.14.1
         */
        status: Status;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.14.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.14.3
         */
        groupId: GroupId;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.14.4
         */
        sceneList?: number[];
    }
    ...
    export class CopySceneRequest {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.15.1
         */
        mode: CopyMode;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.15.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.15.3
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.15.4
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.15.5
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.16
     */
    export class CopySceneResponse {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.16.1
         */
        status: Status;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.16.2
         */
        groupIdentifierFrom: GroupId;
         ...
         * This field shall be set to the same values as in the corresponding fields of the received CopyScene command.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.9.16.3
         */
        sceneIdentifierFrom: number;
    }

    /**
     * @see {@link MatterSpecification.v16.Cluster} § 1.4.7.1
     */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 1.4.7.3
     */
    export class AttributeValuePair {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.7.3.1
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 1.4.7.4
     */
    export class ExtensionFieldSet {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.7.4.1
         */
        clusterId: ClusterId;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.7.4.2
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 1.4.7.5
     */
    export class LogicalSceneTable {
         ...
         * group.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.7.5.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.7.5.2
         */
        sceneId: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.7.5.3
         */
        sceneName?: string;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.7.5.4
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.4.7.5.5
         */

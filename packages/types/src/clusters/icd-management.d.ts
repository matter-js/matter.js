...
export declare namespace IcdManagement {
    ...
    export interface BaseAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 9.16.6.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 9.16.6.3
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 9.16.6.8
         */
    ...
    export interface CheckInProtocolSupportAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 9.16.6.5
         */
        icdCounter: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 9.16.6.6
         */
    ...
    export interface LongIdleTimeSupportAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 9.16.6.9
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Core} § 9.16.4
     */
    export enum Feature {
        /**
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 9.16.4.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 9.16.4.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 9.16.4.3
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 9.16.4.4
         */
        DynamicSitLitSupport = "DynamicSitLitSupport"
    }

    /**
     * @see {@link MatterSpecification.v16.Core} § 9.16.5.3
     */
    export class MonitoringRegistration {
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 9.16.5.3.1
         */
         ...
         * client.
         *
         * @see {@link MatterSpecification.v16.Core} § 9.16.5.3.4
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Core} § 9.16.5.1
     */
    ...
    /**
     * @see {@link MatterSpecification.v16.Core} § 9.16.5.2
     */
     ...
     *
     * @see {@link MatterSpecification.v16.Core} § 9.16.7.5
     */
    export class StayActiveResponse {
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 9.16.7.5.1
         */
    ...
    export class RegisterClientRequest {
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 9.16.7.1.1
         */
        checkInNodeId: NodeId;
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 9.16.7.1.2
         */
        monitoredSubject: SubjectId;
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 9.16.7.1.3
         */
        key: Bytes;
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 9.16.7.1.4
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 9.16.7.1.5
         */
        clientType: ClientType;
    }
     ...
     * command.
     *
     * @see {@link MatterSpecification.v16.Core} § 9.16.7.2
     */
    ...
    export class UnregisterClientRequest {
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 9.16.7.3.1
         */
        checkInNodeId: NodeId;
         ...
         *
         * @see {@link MatterSpecification.v16.Core} § 9.16.7.3.2
         */
        verificationKey?: Bytes;
    }

    /**
     * @see {@link MatterSpecification.v16.Core} § 9.16.5.1.1
     */

...
export declare namespace WebRtcTransportProvider {
    ...
    export interface BaseCommands {
        ...
        /**
         * This command allows for string based ICE candidates RFC8839, Section 5.1, generated after the initial Offer /
         * Answer exchange, via a JSEP onicecandidate event RFC9429, Section 4.1.20, a DOM rtcpeerconnectioniceevent
         * event, or other WebRTC compliant implementations, to be added to a session during the gathering phase. This
    ...
    export enum Feature {
         ...
         *
         * This feature is designed to be JSEP RFC9429 compliant with the RTCDataChannel object interface and consists

...
export declare namespace WebRtcTransportProvider {
    ...
    export interface BaseCommands {
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.3
         */
         ...
         * received on.
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.5
         */
         ...
         * received on.
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.6
         */
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.7
         */
    ...
    export class SolicitOfferRequest {
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.1.1
         */
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.1.2
         */
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.1.4
         */
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.1.3
         */
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.1.5
         */
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.1.6
         */
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.1.7
         */
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.1.8
         */
        videoStreams?: number[];
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.1.9
         */
        audioStreams?: number[];
    }
     ...
     *
     * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.2
     */
    export class SolicitOfferResponse {
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.2.1
         */
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.2.2
         */
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.2.3
         */
        videoStreamId?: number | null;
         ...
         * known or null if unknown at this time.
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.2.4
         */
        audioStreamId?: number | null;
    }
    ...
    export class ProvideOfferRequest {
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.3.1
         */
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.3.2
         */
        sdp: string;
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.3.3
         */
        streamUsage?: StreamUsage;
         ...
         * as a client to invoke the commands on the Requestor cluster.
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.3.4
         */
        originatingEndpointId?: EndpointNumber;
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.3.5
         */
        videoStreamId?: number | null;
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.3.6
         */
        audioStreamId?: number | null;
         ...
         * this session. See ICEServerStruct for further details.
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.3.7
         */
        iceServers?: WebRtcTransportDefinitions.IceServer[];
         ...
         * ICETransportPolicy.
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.3.8
         */
        iceTransportPolicy?: string;
         ...
         * This field indicates if metadata transmission shall be active in this session.
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.3.9
         */
        metadataEnabled?: boolean;
         ...
         * AllocatedVideoStreams attribute.
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.3.10
         */
        videoStreams?: number[];
         ...
         * AllocatedAudioStreams attribute.
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.3.11
         */
        audioStreams?: number[];
    }
     ...
     * attribute.
     *
     * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.4
     */
    export class ProvideOfferResponse {
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.4.1
         */
        webRtcSessionId: number;
         ...
         * known or null if unknown at this time.
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.4.2
         */
        videoStreamId?: number | null;
         ...
         * known or null if unknown at this time.
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.4.3
         */
        audioStreamId?: number | null;
    }
    ...
    export class ProvideAnswerRequest {
         ...
         * This field shall contain the WebRTCSessionID of the established WebRTC session.
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.5.1
         */
        webRtcSessionId: number;
         ...
         * Offer/Answer semantics.
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.5.2
         */
        sdp: string;
    }
    ...
    export class ProvideIceCandidatesRequest {
         ...
         * This field shall contain the WebRTCSessionID of the established WebRTC session.
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.6.1
         */
        webRtcSessionId: number;
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.6.2
         */
    ...
    export class EndSessionRequest {
         ...
         * This field shall contain the WebRTCSessionID of the established WebRTC session.
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.7.1
         */
        webRtcSessionId: number;
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.5.6.7.2
         */

 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 8.12
 */
export declare namespace MicrowaveOvenMode {
    ...
    export interface BaseAttributes {
         ...
         * ModeTags.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.12.5.1
         */
        supportedModes: ModeOption[];

        /**
         * @see {@link MatterSpecification.v16.Cluster} § 8.12.5
         */
        currentMode: number;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 8.12.4
     */
    export enum Feature {
        /**
         * OnOff (DEPONOFF)
    ...
    export enum ModeTag {
        /**
         * @see {@link MatterSpecification.v16.Cluster} § 8.12.7.1
         */
        Auto = 0,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.12.7.1.1
         */
        Normal = 16384,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.12.7.1.2
         */
        Defrost = 16385
    }

 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 9.3
 */
export declare namespace EnergyEvse {
    ...
    export interface BaseAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.8.1
         */
        state: State | null;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.8.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.8.3
         */
         ...
         * being charged.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.8.4
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.8.6
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.8.7
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.8.8
         */
        maximumChargeCurrent: number | bigint;

        /**
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.8
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.8.10
         */
         ...
         * planned start time.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.8.11
         */
    ...
    export interface V2XAttributes {
         ...
         * being discharged.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.8.5
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.8.9
         */
    ...
    export interface ChargingPreferencesAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.8.12
         */
         ...
         * mode tag), or that the vehicle is not plugged in with the SupplyState indicating that charging is enabled.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.8.13
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.8.14
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.8.15
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.8.16
         */
    ...
    export interface SoCReportingAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.8.17
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.8.18
         */
    ...
    export interface PlugAndChargeAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.8.19
         */
    ...
    export interface BaseCommands {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.9.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.9.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.9.4
         */
    ...
    export interface V2XCommands {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.9.3
         */
    ...
    export interface ChargingPreferencesCommands {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.9.5
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.9.6
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.9.8
         */
    ...
    export interface BaseEvents {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.3
         */
         ...
         * Management cluster of the associated Device Energy Management device.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.4
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.5
         */
        fault: FaultEvent;
    }
    ...
    export interface RfidEvents {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.6
         */
        rfid?: RfidEvent;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.3.4
     */
    export enum Feature {
        /**
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.4.1
         */
         ...
         * this cluster.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.4.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.4.3
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.4.4
         */
        Rfid = "Rfid",
         ...
         * fluctuate.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.4.5
         */
        V2X = "V2X"
    }

    /**
     * @see {@link MatterSpecification.v16.Cluster} § 9.3.7.2
     */
    export enum State {
        /**
    ...
    /**
     * @see {@link MatterSpecification.v16.Cluster} § 9.3.7.3
     */
    ...
    /**
     * @see {@link MatterSpecification.v16.Cluster} § 9.3.7.4
     */
    ...
    export class EnableChargingRequest {
         ...
         * permanently.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.9.2.1
         */
        chargingEnabledUntil: number | null;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.9.2.2
         */
        minimumChargeCurrent: number | bigint;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.9.2.3
         */
        maximumChargeCurrent: number | bigint;
    }
    ...
    export class EnableDischargingRequest {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.9.3.1
         */
        dischargingEnabledUntil: number | null;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.9.3.2
         */
        maximumDischargeCurrent: number | bigint;
    }
    ...
    export class SetTargetsRequest {
         ...
         * this list field.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.9.5.1
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.3.9.7
     */
    export class GetTargetsResponse {
         ...
         * days of the week.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.9.7.1
         */
        chargingTargetSchedules: ChargingTargetSchedule[];
    }
    ...
    export class EvConnectedEvent {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.1.1
         */
        sessionId: number;
    }
    ...
    export class EvNotDetectedEvent {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.2.1
         */
        sessionId: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.2.2
         */
        state: State;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.2.3
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.2.4
         */
         ...
         * energy.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.2.5
         */
    ...
    export class EnergyTransferStartedEvent {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.3.1
         */
        sessionId: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.3.2
         */
        state: State;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.3.3
         */
         ...
         * discharging.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.3.4
         */
        maximumDischargeCurrent?: number | bigint;
    }
    ...
    export class EnergyTransferStoppedEvent {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.4.1
         */
        sessionId: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.4.2
         */
        state: State;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.4.3
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.4.4
         */
         ...
         * EnergyTransferStarted event, in mWh.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.4.5
         */
    ...
    export class FaultEvent {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.5.1
         */
        sessionId: number | null;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.5.2
         */
        state: State;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.5.3
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.5.4
         */
    ...
    export class RfidEvent {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.10.6.1
         */
        uid: Bytes;
    }

    /**
     * @see {@link MatterSpecification.v16.Cluster} § 9.3.7.1
     */
    ...
    /**
     * @see {@link MatterSpecification.v16.Cluster} § 9.3.7.5
     */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.3.7.6
     */
    export class ChargingTarget {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.7.6.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.7.6.2
         */
        targetSoC?: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.7.6.3
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.3.7.7
     */
    export class ChargingTargetSchedule {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.7.8
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.3.7.9
         */

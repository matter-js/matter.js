 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 7.3
 */
export declare namespace RvcCleanMode {
    ...
    export interface BaseAttributes {
         ...
         * ModeTags field list.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 7.3.6.1
         */
        supportedModes: ModeOption[];

        /**
         * @see {@link MatterSpecification.v16.Cluster} § 7.3.6
         */
        currentMode: number;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 7.3.4
     */
    export enum Feature {
        /**
         * OnOff (DEPONOFF)
         ...
         * InvalidInMode value.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 7.3.4.1
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 7.3.5.1
     */
    ...
    export enum ModeChangeStatus {
        /**
         * @see {@link MatterSpecification.v16.Cluster} § 7.3.7.1
         */
    ...
    export enum ModeTag {
        /**
         * @see {@link MatterSpecification.v16.Cluster} § 7.3.7.2
         */
        Auto = 0,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 7.3.7.2.2
         */
        Vacuum = 16385,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 7.3.7.2.3
         */
        Mop = 16386,

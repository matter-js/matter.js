 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 8.5
 */
export declare namespace LaundryWasherMode {
    ...
    export interface BaseAttributes {
         ...
         * list.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.5.6.1
         */
        supportedModes: ModeOption[];

        /**
         * @see {@link MatterSpecification.v16.Cluster} § 8.5.6
         */
        currentMode: number;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 8.5.4
     */
    export enum Feature {
        /**
         * OnOff (DEPONOFF)
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 8.5.5.1
     */
    ...
    export enum ModeTag {
        /**
         * @see {@link MatterSpecification.v16.Cluster} § 8.5.7.1
         */
        Auto = 0,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.5.7.1.1
         */
        Normal = 16384,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.5.7.1.2
         */
        Delicate = 16385,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.5.7.1.3
         */
        Heavy = 16386,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.5.7.1.4
         */
        Whites = 16387
    }

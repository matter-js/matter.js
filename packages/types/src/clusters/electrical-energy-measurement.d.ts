 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 2.12
 */
export declare namespace ElectricalEnergyMeasurement {
    ...
    export interface BaseAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.6.1
         */
    ...
    export interface ImportedEnergyAndCumulativeEnergyAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.6.2
         */
    ...
    export interface ExportedEnergyAndCumulativeEnergyAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.6.3
         */
    ...
    export interface ImportedEnergyAndPeriodicEnergyAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.6.4
         */
    ...
    export interface ExportedEnergyAndPeriodicEnergyAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.6.5
         */
    ...
    export interface CumulativeEnergyAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.6.6
         */
    ...
    export interface CumulativeEnergyEvents {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.7.1
         */
    ...
    export interface PeriodicEnergyEvents {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.7.2
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 2.12.4
     */
    export enum Feature {
        /**
         * ImportedEnergy (IMPE)
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.4.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.4.2
         */
         ...
         * factory reset.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.4.3
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.4.4
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 2.12.5.2
     */
    export class EnergyMeasurement {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.5.2.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.5.2.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.5.2.3
         */
        endTimestamp?: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.5.2.4
         */
         ...
         * EndTimestamp.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.5.2.5
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.5.2.6
         */
         ...
         * specified by the StartSystime and EndSystime fields, or both.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.5.2.7
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 2.12.5.3
     */
    export class CumulativeEnergyReset {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.5.3.1
         */
         ...
         * recently zero cannot currently be determined, a value of null shall be returned.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.5.3.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.5.3.3
         */
         ...
         * value shall be the time elapsed since boot at the UTC time indicated in ImportedResetTimestamp.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.5.3.4
         */
    ...
    export class CumulativeEnergyMeasuredEvent {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.7.1.1
         */
         ...
         * EndTimestamp field, EndSystime field, or both.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.7.1.2
         */
    ...
    export class PeriodicEnergyMeasuredEvent {
         ...
         * EndTimestamp field, EndSystime field, or both.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.7.2.1
         */
        energyImported?: EnergyMeasurement;
         ...
         * EndTimestamp field, EndSystime field, or both.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.12.7.2.2
         */
        energyExported?: EnergyMeasurement;
    }

    /**
     * @see {@link MatterSpecification.v16.Cluster} § 2.12.5.1
     */
    ...
    /**
     * @deprecated Scheduled for removal in 0.19. Use {@link ElectricalEnergyMeasurement}.
     */

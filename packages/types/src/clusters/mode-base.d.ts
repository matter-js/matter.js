 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 1.10
 */
export declare namespace ModeBase {
    ...
    export interface BaseAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.10.6.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.10.6.2
         */
        currentMode: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.10.6.3
         */
    ...
    export interface OnOffAttributes {
         ...
         * The value of this field shall match the Mode field of one of the entries in the SupportedModes attribute.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.10.6.4
         */
        onMode: number | null;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 1.10.4
     */
    export enum Feature {
        /**
         * OnOff (DEPONOFF)
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.10.4.1
         */
        OnOff = "OnOff"
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 1.10.5.2
     */
    ...
    export class ChangeToModeRequest {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.10.7.1.1
         */
        newMode: number;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 1.10.7.2
     */
    export class ChangeToModeResponse {
        constructor(values?: Partial<ChangeToModeResponse>);

        /**
         * @see {@link MatterSpecification.v16.Cluster} § 1.10.7.2.1
         */
    ...
    export enum ModeChangeStatus {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.10.7.2.1.2
         */
        Success = 0,
    ...
    export enum ModeTag {
        /**
         * @see {@link MatterSpecification.v16.Cluster} § 1.10.8
         */
        Auto = 0,

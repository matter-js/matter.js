 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 11.3
 */
export declare namespace CameraAvSettingsUserLevelManagement {
    ...
    export interface MechanicalPanOrMechanicalTiltOrMechanicalZoomAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.6.10
         */
    ...
    export interface MechanicalZoomAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.6.5
         */
        zoomMax: number;
    }
    ...
    export interface MechanicalTiltAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.6.6
         */
        tiltMin: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.6.7
         */
        tiltMax: number;
    }
    ...
    export interface MechanicalPanAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.6.8
         */
        panMin: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.6.9
         */
        panMax: number;
    }
    ...
    export interface MechanicalPanOrMechanicalTiltOrMechanicalZoomCommands {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.2
         */
    ...
    export interface MechanicalPresetsCommands {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.3
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.4
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.5
         */
    ...
    export interface DigitalPtzCommands {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.6
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.7
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 11.3.4
     */
    export enum Feature {
        /**
         * DigitalPtz (DPTZ)
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.4.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.4.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.4.3
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.4.4
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.4.5
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 11.3.5.3
     */
    export class Mptz {
         ...
         * coordinate system.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.5.3.1
         */
        pan?: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.5.3.2
         */
        tilt?: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.5.3.3
         */
        zoom?: number;
    }
     ...
     * could be.
     *
     * @see {@link MatterSpecification.v16.Cluster} § 11.3.5.1
     */
    export enum PhysicalMovement {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.5.1.1
         */
        Idle = 0,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.5.1.2
         */
        Moving = 1
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 11.3.5.4
     */
    export class MptzPreset {
         ...
         * tilt and zoom.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.5.4.1
         */
        presetId: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.5.4.2
         */
        name: string;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.5.4.3
         */
        settings: Mptz;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 11.3.5.2
     */
    export class Dptz {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.5.2.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.5.2.2
         */
        viewport: Viewport;
    }
    ...
    export class MptzSetPositionRequest {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.1.1
         */
        pan?: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.1.2
         */
        tilt?: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.1.3
         */
        zoom?: number;
    }
    ...
    export class MptzRelativeMoveRequest {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.2.1
         */
        panDelta?: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.2.2
         */
        tiltDelta?: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.2.3
         */
        zoomDelta?: number;
    }
    ...
    export class MptzMoveToPresetRequest {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.3.1
         */
        presetId: number;
    }
    ...
    export class MptzSavePresetRequest {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.4.1
         */
        presetId?: number;
    ...
    export class MptzRemovePresetRequest {
         ...
         * This field shall indicate the ID of an entry in MptzPresets.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.5.1
         */
        presetId: number;
    }
    ...
    export class DptzSetViewportRequest {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.6.1
         */
        videoStreamId: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.6.2
         */
        viewport: Viewport;
    }
    ...
    export class DptzRelativeMoveRequest {
         ...
         * This field shall be a VideoStreamID representing the video stream to modify.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.7.1
         */
        videoStreamId: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.7.2
         */
        deltaX?: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.7.3
         */
        deltaY?: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 11.3.7.7.4
         */
        zoomDelta?: number;
    }

 ...
 * for oven devices.
 *
 * @see {@link MatterSpecification.v16.Cluster} § 8.11
 */
export declare namespace OvenMode {
    ...
    export interface BaseAttributes {
         ...
         * list.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.11.6.1
         */
        supportedModes: ModeOption[];

        /**
         * @see {@link MatterSpecification.v16.Cluster} § 8.11.6
         */
        currentMode: number;
    }
    ...
    export interface BaseCommands {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.10.7.1
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 8.11.4
     */
    export enum Feature {
        /**
         * OnOff (DEPONOFF)
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 8.11.5.1
     */
    export class ModeOption {
         ...
         * user.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.10.5.2.1
         */
        label: string;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.10.5.2.2
         */
        mode: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.10.5.2.3
         */
    ...
    export enum ModeTag {
        /**
         * @see {@link MatterSpecification.v16.Cluster} § 8.11.7.1
         */
        Auto = 0,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.11.7.1.1
         */
        Bake = 16384,
         ...
         * duration.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.11.7.1.2
         */
        Convection = 16385,
         ...
         * regions.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.11.7.1.3
         */
        Grill = 16386,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.11.7.1.4
         */
        Roast = 16387,
         ...
         *   this mode:
         *
         *   - It may NOT be possible to start this mode from a client. It may need to be started at the device due to
         *     the temperatures used during this mode. - The setting of the oven temperature or other features may be
         *     limited or not available while this mode is running. - Oven temperature measurement may NOT be available
         *     while this mode is running.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.11.7.1.5
         */
        Clean = 16388,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.11.7.1.8
         */
        Warming = 16391,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.11.7.1.9
         */
        Proofing = 16392,
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 1.10.5.1
     */
    export class ModeTagStruct {
         ...
         * salt.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.10.5.1.1
         */
        mfgCode?: VendorId;
         ...
         * standard.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.10.5.1.2
         */

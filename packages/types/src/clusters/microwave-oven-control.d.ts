 ...
 * this cluster.
 *
 * @see {@link MatterSpecification.v16.Cluster} § 8.13
 */
export declare namespace MicrowaveOvenControl {
    ...
    export interface BaseAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.13.5.1
         */
        cookTime: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.13.5.2
         */
        maxCookTime: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.13.5.9
         */
        wattRating?: number;
    }
    ...
    export interface PowerAsNumberAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.13.5.3
         */
        powerSetting: number;
    }
    ...
    export interface PowerNumberLimitsAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.13.5.4
         */
        minPower: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.13.5.5
         */
        maxPower: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.13.5.6
         */
        powerStep: number;
    }
    ...
    export interface BaseCommands {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.13.6.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.13.6.3
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 8.13.4
     */
    export enum Feature {
        /**
    ...
    export class SetCookingParametersRequest {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.13.6.2.1
         */
        cookMode?: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.13.6.2.2
         */
        cookTime?: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.13.6.2.3
         */
        powerSetting?: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.13.6.2.4
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.13.6.2.5
         */
    ...
    export class AddMoreTimeRequest {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.13.6.3.1
         */
        timeToAdd: number;
    }

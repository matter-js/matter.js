 ...
 * for EVSE devices.
 *
 * @see {@link MatterSpecification.v16.Cluster} § 9.4
 */
export declare namespace EnergyEvseMode {
    ...
    export interface BaseAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.4.6.1
         */
        supportedModes: ModeOption[];

        /**
         * @see {@link MatterSpecification.v16.Cluster} § 9.4.6
         */
        currentMode: number;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.4.4
     */
    export enum Feature {
        /**
         * OnOff (DEPONOFF)
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.4.5.1
     */
    ...
    export enum ModeTag {
        /**
         * @see {@link MatterSpecification.v16.Cluster} § 9.4.7.1
         */
        Auto = 0,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.4.7.1.1
         */
        Manual = 16384,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.4.7.1.2
         */
        TimeOfUse = 16385,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.4.7.1.3
         */
        SolarCharging = 16386,
         ...
         *   actually occur.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.4.7.1.4
         */
        V2X = 16387
    }

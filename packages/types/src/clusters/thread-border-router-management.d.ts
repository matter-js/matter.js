 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 10.3
 */
export declare namespace ThreadBorderRouterManagement {
    ...
    export interface BaseAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 10.3.5.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 10.3.5.2
         */
        borderAgentId: Bytes;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 10.3.5.3
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 10.3.5.4
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 10.3.5.5
         */
         ...
         * which the border router is connected.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 10.3.5.6
         */
    ...
    export interface BaseCommands {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 10.3.6.1
         */
         ...
         * Otherwise, this shall generate a DatasetResponse command.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 10.3.6.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 10.3.6.4
         */
    ...
    export interface PanChangeCommands {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 10.3.6.5
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 10.3.4
     */
    export enum Feature {
        /**
         * PanChange (PC)
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 10.3.4.1
         */
        PanChange = "PanChange"
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 10.3.6.3
     */
    export class DatasetResponse {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 10.3.6.3.1
         */
        dataset: Bytes;
    }
    ...
    export class SetActiveDatasetRequest {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 10.3.6.4.1
         */
        activeDataset: Bytes;

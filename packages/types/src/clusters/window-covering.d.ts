 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 5.3
 */
export declare namespace WindowCovering {
    ...
    export interface BaseAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.6.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.6.5
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.6.12
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.6.14
         */
        mode: Mode;
    ...
    export interface LiftAttributes {
         ...
         * installed.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.6.3
         */
    ...
    export interface TiltAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.6.4
         */
    ...
    export interface LiftAndPositionAwareLiftAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.6.10
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.6.6
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.6.8
         */
    ...
    export interface TiltAndPositionAwareTiltAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.6.11
         */
         ...
         * Indicates the actual position as a percentage with a minimal step of 0.01%. E.g Max 10000 equals 100.00%.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.6.7
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.6.9
         */
    ...
    export interface BaseCommands {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.7.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.7.2
         */
         ...
         *     value.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.7.3
         */
    ...
    export interface LiftCommands {
         ...
         * returned.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.7.4
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 5.3.4
     */
    export enum Feature {
        /**
         * Lift (LF)
         ...
         * Close).
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.4.1
         */
        Lift = "Lift",
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.4.2
         */
        Tilt = "Tilt",
    ...
    /**
     * @see {@link MatterSpecification.v16.Cluster} § 5.3.5.5
     */
    ...
    /**
     * @see {@link MatterSpecification.v16.Cluster} § 5.3.5.1
     */
    export class ConfigStatus {
         ...
         *   - 1 = Operational
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.5.1.1
         */
        operational?: boolean;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.5.1.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.5.1.3
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.5.1.4
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.5.1.5
         */
         ...
         *   - 1 = Encoder Controlled
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.5.1.6
         */
     ...
     *   - 11b = Reserved
     *
     * @see {@link MatterSpecification.v16.Cluster} § 5.3.5.3
     */
    export class OperationalStatus {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.5.3.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.5.3.2
         */
        lift?: MovementStatus;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.5.3.3
         */
        tilt?: MovementStatus;
    }

    /**
     * @see {@link MatterSpecification.v16.Cluster} § 5.3.5.6
     */
    ...
    /**
     * @see {@link MatterSpecification.v16.Cluster} § 5.3.5.2
     */
    export class Mode {
         ...
         *   - 1 = Lift movement is reversed
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.5.2.1
         */
         ...
         *   - 1 = Calibration mode
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.5.2.2
         */
         ...
         *   - 1 = Maintenance mode
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.5.2.3
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 5.3.5.2.4
         */
        ledFeedback?: boolean;
    }

    /**
     * @see {@link MatterSpecification.v16.Cluster} § 5.3.5.4
     */

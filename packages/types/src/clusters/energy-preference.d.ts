 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 9.7
 */
export declare namespace EnergyPreference {
    ...
    export interface EnergyBalanceAttributes {
         ...
         * of 100.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.7.6.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.7.6.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.7.6.3
         */
    ...
    export interface LowPowerModeSensitivityAttributes {
         ...
         * list.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.7.6.4
         */
         ...
         * previous value.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.7.6.5
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.7.4
     */
    export enum Feature {
        /**
         * EnergyBalance (BALA)
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.7.4.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.7.4.2
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.7.5.2
     */
    export class Balance {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.7.5.2.1
         */
        step: number;
         ...
         * value.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.7.5.2.2
         */
        label?: string;
    }

    /**
     * @see {@link MatterSpecification.v16.Cluster} § 9.7.5.1
     */
    export enum EnergyPriority {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.7.5.1.1
         */
        Comfort = 0,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.7.5.1.2
         */
        Speed = 1,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.7.5.1.3
         */
        Efficiency = 2,

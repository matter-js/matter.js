 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 2.8
 */
export declare namespace ResourceMonitoring {
    ...
    export interface BaseAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.8.6.4
         */
    ...
    export interface ConditionAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.8.6.1
         */
        condition: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.8.6.2
         */
    ...
    export interface ReplacementProductListAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.8.6.6
         */
    ...
    export interface BaseCommands {
         ...
         * the attribute.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 2.8.7.1
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 2.8.4
     */
    export enum Feature {
        /**
         * Condition (CON)
    ...
    /**
     * @see {@link MatterSpecification.v16.Cluster} § 2.8.5.2
     */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 2.8.5.1
     */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 2.8.5.4
     */
     ...
     * specific ones.
     *
     * @see {@link MatterSpecification.v16.Cluster} § 2.8.5.3
     */

 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 7.2
 */
export declare namespace RvcRunMode {
    ...
    export interface BaseAttributes {
         ...
         * ModeTags.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 7.2.6.1
         */
        supportedModes: ModeOption[];

        /**
         * @see {@link MatterSpecification.v16.Cluster} § 7.2.6
         */
        currentMode: number;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 7.2.4
     */
    export enum Feature {
        /**
         * OnOff (DEPONOFF)
         ...
         * InvalidInMode value.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 7.2.4.1
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 7.2.5.1
     */
    ...
    export enum ModeChangeStatus {
        /**
         * @see {@link MatterSpecification.v16.Cluster} § 7.2.7.1
         */
        Stuck = 65,
    ...
    export enum ModeTag {
        /**
         * @see {@link MatterSpecification.v16.Cluster} § 7.2.7.2
         */
        Auto = 0,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 7.2.7.2.1
         */
        Idle = 16384,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 7.2.7.2.2
         */
        Cleaning = 16385,
         ...
         *   experience.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 7.2.7.2.3
         */
        Mapping = 16386
    }

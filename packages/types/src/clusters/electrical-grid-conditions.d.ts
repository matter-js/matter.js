 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 9.13
 */
export declare namespace ElectricalGridConditions {
    ...
    export interface BaseAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.13.6.1
         */
    ...
    export interface ForecastingAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.13.6.3
         */
    ...
    export interface BaseEvents {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.13.7.1
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.13.4
     */
    export enum Feature {
        /**
         * Forecasting (FORE)
         ...
         * hours in the future.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.13.4.1
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.13.5.2
     */
    export class ElectricalGridConditionsStruct {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.13.5.2.1
         */
        periodStart: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.13.5.2.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.13.5.2.3
         */
         ...
         * world.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.13.5.2.4
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.13.5.2.5
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.13.5.2.6
         */
    ...
    export class CurrentConditionsChangedEvent {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.13.7.1.1
         */
        currentConditions: ElectricalGridConditionsStruct | null;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.13.5.1
     */

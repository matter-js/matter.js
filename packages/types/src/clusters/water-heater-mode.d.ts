 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 9.6
 */
export declare namespace WaterHeaterMode {
    ...
    export interface BaseAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.6.6.1
         */
        supportedModes: ModeOption[];

        /**
         * @see {@link MatterSpecification.v16.Cluster} § 9.6.6
         */
        currentMode: number;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.6.4
     */
    export enum Feature {
        /**
         * OnOff (DEPONOFF)
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.6.5.1
     */
    ...
    export enum ModeTag {
        /**
         * @see {@link MatterSpecification.v16.Cluster} § 9.6.7.1
         */
        Auto = 0,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.6.7.1.1
         */
        Off = 16384,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.6.7.1.2
         */
        Manual = 16385,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.6.7.1.3
         */
        Timed = 16386
    }

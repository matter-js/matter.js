 ...
 * the premises.
 *
 * @see {@link MatterSpecification.v16.Cluster} § 9.9
 */
export declare namespace CommodityPrice {
    ...
    export interface BaseAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.6.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.6.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.6.3
         */
    ...
    export interface ForecastingAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.6.4
         */
    ...
    export interface BaseCommands {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.7.1
         */
    ...
    export interface ForecastingCommands {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.7.3
         */
    ...
    export interface BaseEvents {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.8.1
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.9.4
     */
    export enum Feature {
        /**
         * Forecasting (FORE)
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.9.5.3
     */
    export class CommodityPriceStruct {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.5.3.1
         */
        periodStart: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.5.3.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.5.3.3
         */
        price?: number | bigint;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.5.3.4
         */
        priceLevel?: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.5.3.5
         */
        description?: string;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.5.3.6
         */
    ...
    export class GetDetailedPriceRequest {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.7.1.1
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.9.7.2
     */
    export class GetDetailedPriceResponse {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.7.2.1
         */
        currentPrice: CommodityPriceStruct | null;
    }
    ...
    export class GetDetailedForecastRequest {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.7.3.1
         */
        details: CommodityPriceDetail;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.9.7.4
     */
    export class GetDetailedForecastResponse {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.7.4.1
         */
        priceForecast: CommodityPriceStruct[];
    }
    ...
    export class PriceChangeEvent {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.8.1.1
         */
        currentPrice: CommodityPriceStruct | null;
    }

    /**
     * @see {@link MatterSpecification.v16.Cluster} § 9.9.5.1
     */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.9.5.2
     */
    export class CommodityPriceComponent {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.5.2.1
         */
        price: number | bigint;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.5.2.3
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.5.2.4
         */
        description?: string;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.9.5.2.5
         */

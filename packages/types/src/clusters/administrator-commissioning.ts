...
export namespace AdministratorCommissioning {
    ...
    export const Base = MutableCluster.Component({
        ...
        commands: {
             ...
             * accepts PASE sessions. The current Administrator shall specify a timeout value for the duration of the
            ...
            /**
             * This command is used by a current Administrator to instruct a Node to revoke any active Section
             * 11.19.8.1, “OpenCommissioningWindow” or Section 11.19.8.2, “OpenBasicCommissioningWindow” command. This
             * is an idempotent command and the Node shall (for ECM) delete the temporary PAKEPasscodeVerifier and
             * associated data, terminate any open PASE sessions or sessions in the process of being established, and
             * stop publishing the DNS-SD record associated with the Section 11.19.8.1, “OpenCommissioningWindow” or
             * Section 11.19.8.2, “OpenBasicCommissioningWindow” command, see Section 4.3.1, “Commissionable Node
             * Discovery”.
             *

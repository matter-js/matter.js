 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 8.7
 */
export declare namespace RefrigeratorAndTemperatureControlledCabinetMode {
    ...
    export interface BaseAttributes {
         ...
         * list.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.7.6.1
         */
        supportedModes: ModeOption[];

        /**
         * @see {@link MatterSpecification.v16.Cluster} § 8.7.6
         */
        currentMode: number;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 8.7.4
     */
    export enum Feature {
        /**
         * OnOff (DEPONOFF)
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 8.7.5.1
     */
    ...
    export enum ModeTag {
        /**
         * @see {@link MatterSpecification.v16.Cluster} § 8.7.7.1
         */
        Auto = 0,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.7.7.1.1
         */
        RapidCool = 16384,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 8.7.7.1.2
         */
        RapidFreeze = 16385
    }

 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 6.8
 */
export declare namespace KeypadInput {
    ...
    export interface BaseCommands {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 6.8.6.1
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 6.8.4
     */
    export enum Feature {
        /**
    ...
    export class SendKeyRequest {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 6.8.6.1.1
         */
        keyCode: CecKeyCode;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 6.8.6.2
     */
    export class SendKeyResponse {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 6.8.6.2.1
         */
        status: Status;
    }

    /**
     * @see {@link MatterSpecification.v16.Cluster} § 6.8.5.1
     */
    export enum Status {
        /**
         * Succeeded
    ...
    /**
     * @see {@link MatterSpecification.v16.Cluster} § 6.8.5.2
     */

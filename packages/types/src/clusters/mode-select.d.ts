 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 1.9
 */
export declare namespace ModeSelect {
    ...
    export interface BaseAttributes {
         ...
         * the instances.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.9.6.1
         */
        description: string;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.9.6.4
         */
        currentMode: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.9.6.5
         */
    ...
    export interface OnOffAttributes {
         ...
         * The value of this field shall match the Mode field of one of the entries in the SupportedModes attribute.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.9.6.6
         */
        onMode: number | null;
    }
    ...
    export interface BaseCommands {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.9.7.1
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 1.9.4
     */
    export enum Feature {
        /**
         * OnOff (DEPONOFF)
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.9.4.1
         */
        OnOff = "OnOff"
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 1.9.5.2
     */
    export class ModeOption {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.9.5.2.1
         */
        label: string;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.9.5.2.2
         */
        mode: number;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.9.5.2.3
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 1.9.5.1
     */
    export class SemanticTag {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.9.5.1.2
         */
        mfgCode: VendorId;
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 1.9.5.1.1
         */
        value: number;
    }

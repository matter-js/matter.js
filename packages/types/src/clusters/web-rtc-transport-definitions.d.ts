...
export declare namespace WebRtcTransportDefinitions {
    ...
    /**
     * @see {@link MatterSpecification.v151.Cluster} § 11.4.5.2
     */
     ...
     *
     * @see {@link MatterSpecification.v151.Cluster} § 11.4.5.3
     */
    export class IceServer {
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.4.5.3.1
         */
        urLs: string[];
         ...
         * username field.
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.4.5.3.2
         */
        username?: string;
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.4.5.3.3
         */
        credential?: string;
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.4.5.3.4
         */
        caid?: number;
    }
     ...
     *
     * @see {@link MatterSpecification.v151.Cluster} § 11.4.5.4
     */
    export class IceCandidate {
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.4.5.4.1
         */
        candidate: string;
         ...
         * this value.
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.4.5.4.2
         */
        sdpMid: string | null;
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.4.5.4.3
         */
     ...
     *
     * @see {@link MatterSpecification.v151.Cluster} § 11.4.5.5
     */
    export class WebRtcSession {
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.4.5.5.1
         */
        id: number;
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.4.5.5.2
         */
        peerNodeId: NodeId;
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.4.5.5.3
         */
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.4.5.5.4
         */
         ...
         * session.
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.4.5.5.5
         */
         ...
         * session.
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.4.5.5.6
         */
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.4.5.5.7
         */
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.4.5.5.8
         */
        videoStreams?: number[];
         ...
         *
         * @see {@link MatterSpecification.v151.Cluster} § 11.4.5.5.9
         */
        audioStreams?: number[];

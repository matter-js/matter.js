 ...
 * premises.
 *
 * @see {@link MatterSpecification.v16.Cluster} § 9.11
 */
export declare namespace CommodityMetering {
    ...
    export interface BaseAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.11.5.3
         */
         ...
         * indicates that metering data is currently unavailable.
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.11.5.4
         */
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.11.4.1
     */
    export class MeteredQuantity {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.11.4.1.2
         */

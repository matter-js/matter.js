 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 9.8
 */
export declare namespace DeviceEnergyManagementMode {
    ...
    export interface BaseAttributes {
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.8.6.1
         */
        supportedModes: ModeOption[];

        /**
         * @see {@link MatterSpecification.v16.Cluster} § 9.8.6
         */
        currentMode: number;
    }
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.8.4
     */
    export enum Feature {
        /**
         * OnOff (DEPONOFF)
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.8.5.1
     */
    ...
    export enum ModeTag {
        /**
         * @see {@link MatterSpecification.v16.Cluster} § 9.8.7.1
         */
        Auto = 0,
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.8.7.1.1
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.8.7.1.2
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.8.7.1.3
         */
         ...
         *
         * @see {@link MatterSpecification.v16.Cluster} § 9.8.7.1.4
         */

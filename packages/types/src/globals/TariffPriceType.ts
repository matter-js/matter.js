...
/**
 * @see {@link MatterSpecification.v16.Cluster} § 9.1.5
 */
export enum TariffPriceType {
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.1.5.1
     */
    Standard = 0,
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.1.5.2
     */
    Critical = 1,
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.1.5.3
     */
    Virtual = 2,
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.1.5.4
     */
    Incentive = 3,
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.1.5.5
     */
    IncentiveSignal = 4
}

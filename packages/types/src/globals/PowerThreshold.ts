 ...
 *
 * @see {@link MatterSpecification.v16.Cluster} § 9.1.6
 */
export const TlvPowerThreshold = TlvObject({
     ...
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.1.6.1
     */
     ...
     * (DNO).
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.1.6.2
     */
     ...
     * field shall be null.
     *
     * @see {@link MatterSpecification.v16.Cluster} § 9.1.6.3
     */

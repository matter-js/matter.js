...
Resource.add({
    ...
    children: [
...

        {
            ...
            details: "This type shall specify the RFC8825 compliant ICE servers RFC8839 used to facilitate the negotiation " +
                "of peer-to-peer connections through NATs (Network Address Translators) and firewalls. It mimics the " +
                ...
                "\n" +
                "  - STUN RFC8489 Servers, which help to discover the public IP address and NAT/Firewall type if any, " +
                "of a device. When a WebRTC session starts, it contacts the STUN server, which returns the " +
                "device's public IP and port number. This information is used to generate ICE candidates for the " +
            ...
            children: [
...

                {
                    ...
                    details: "(Optional for STUN, usually required for TURN) The RFC8489 compliant UTF-8 encoded username required " +
                        "for authentication with the STUN or TURN servers found in the URLs field. This field maps to the " +
                        "RTCIceServer username field."
                },

                {
                    tag: "field", name: "Credential", xref: "cluster§11.4.5.3.3",
                    details: "(Optional for STUN, usually required for TURN) The RFC8489 compliant UTF-8 encoded short-term " +
...

        {
            ...
            details: "This type shall specify the RFC8825 compliant ICE Candidate RFC8839 used to facilitate the " +
                "negotiation of peer-to-peer connections through NATs (Network Address Translators) and firewalls. It " +
                "mimics the model used in the W3C WebRTC API RTCIceCandidate dictionary.",

            children: [
                {
                    tag: "field", name: "Candidate", xref: "cluster§11.4.5.4.1",

                    details: "This field shall specify the RFC8825 compliant RFC8839 candidate-attribute field in string form. " +
...

                {
                    ...
                    details: "This field shall specify the zero-based index number of the media description (as defined in " +
                        "RFC8866) in the SDP with which the Candidate is associated or null if no such association exists. " +
                        "This is the same value as the W3C WebRTC API RTCIceCandidate sdpMLineIndex value."
                }
            ]
        },

        {
            ...
            children: [
                ...
                {
                    tag: "field", name: "VideoStreams", xref: "cluster§11.4.5.5.8",
                ...
                {
                    tag: "field", name: "AudioStreams", xref: "cluster§11.4.5.5.9",

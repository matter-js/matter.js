        ...
        children: [
            {
                ...
                children: [
                    ...
                    {
                        tag: "field", name: "AUX", xref: "core§9.10.4.3",
                        details: "This feature indicates that there may be entries in the AuxiliaryACL attribute which indicate " +
                            ...
                            "auxiliary means (not explicit ACL attribute list writes) to some subjects by virtue of group " +
                            "membership. See the AuxiliaryACL attribute."
                    }
                ]
            },
            ...
            {
                tag: "attribute", name: "AuxiliaryAcl", xref: "core§9.10.6.10",
                ...
                details: "Indicates a list of additional ACL entries generated by the server that shall be applied during the " +
                    ...
                    "management of the ACL list." +
                    "\n" +
                    "The purpose of exposing these entries in the data model is to ensure transparency in the access " +
                    "granted to subjects." +
                    "\n" +
                    "Changes to this attribute resulting from reconfiguration of the underlying features shall cause the " +
                    "AuxiliaryAccessUpdated event to be generated when they occur. See the AuxiliaryAccessUpdated Event " +
                    ...
                    "\n" +
                    "The entries in this list shall NOT count towards the AccessControlEntriesPerFabric attribute limit, " +
                    "which applies only to the writable entries in the ACL attribute." +
                    "\n" +
                    ...
                    "\n" +
                    "Each feature which would cause entries to appear in this attribute shall individually specify the " +
                    "format of entries that are auto-generated, and under which circumstances they are generated."
            },
                ...
                children: [
...

                    {
                        ...
                        details: "This field shall indicate the URL for the service associated with the device maker which the user " +
                            ...
                            "specified in [[RFC1738]](#ref_Rfc1738) and shall use the https scheme for internet-hosted URLs." +
                            "\n" +
            ...
            {
                tag: "datatype", name: "AccessControlAuxiliaryTypeEnum", xref: "core§9.10.5.5",

                children: [
                    {
                        tag: "field", name: "System",
                        description: "This ACL entry exists because of some system reason and is likely non-revocable"
                    },
                    {
                        tag: "field", name: "Groupcast",
                        description: "Synthesized via Groupcast Cluster administrator-configured group membership"
                    }
                ]
            },

            { tag: "datatype", name: "AccessControlTargetStruct", xref: "core§9.10.5.6" },

            {
                tag: "datatype", name: "AccessControlEntryStruct", xref: "core§9.10.5.7",

                children: [
                    {
                        tag: "field", name: "Privilege", xref: "core§9.10.5.7.1",
                    ...
                    {
                        tag: "field", name: "Targets", xref: "core§9.10.5.7.4",
                    ...
                    {
                        tag: "field", name: "AuxiliaryType", xref: "core§9.10.5.7.5",
                        ...
                        details: "This field, if present, shall indicate the type of AuxiliaryACL entry stored. For example, for " +
                            ...
                            "information provided by this field to determine the feature that caused the auxiliary ACL entry to " +
                            "be created, so that access can be managed via that other feature's operations." +
                            "\n" +
            ...
            {
                tag: "datatype", name: "AccessControlExtensionStruct", xref: "core§9.10.5.8",

                children: [{
                    tag: "field", name: "Data", xref: "core§9.10.5.8.1",
            ...
            {
                tag: "datatype", name: "AccessRestrictionStruct", xref: "core§9.10.5.9",
                details: "This structure describes an access restriction that would be applied to a specific data model " +
                    "element on a given endpoint/cluster pair (see Section 9.10.5.10, \"AccessRestrictionEntryStruct\").",

                children: [
                    {
                        tag: "field", name: "Type", xref: "core§9.10.5.9.1",
                        details: "This field shall indicate the type of restriction, for example, AttributeAccessForbidden."
                    },

                    {
                        tag: "field", name: "Id", xref: "core§9.10.5.9.2",
            ...
            {
                tag: "datatype", name: "AccessRestrictionEntryStruct", xref: "core§9.10.5.10",
            ...
            {
                tag: "datatype", name: "CommissioningAccessRestrictionEntryStruct", xref: "core§9.10.5.11",
                details: "This structure describes a current access restriction when there is no accessing fabric.",

                children: [
                    {
                        tag: "field", name: "Endpoint", xref: "core§9.10.5.11.1",
                        details: "This field shall indicate the endpoint having associated access restrictions scoped to the " +
                            "associated fabric of the list containing the entry."
                    },
                    {
                        tag: "field", name: "Cluster", xref: "core§9.10.5.11.2",
                        details: "This field shall indicate the cluster having associated access restrictions under the entry's " +
                            "Endpoint, scoped to the associated fabric of the list containing the entry."
                    },

                    {
                        tag: "field", name: "Restrictions", xref: "core§9.10.5.11.3",
                        details: "This field shall indicate the set of restrictions applying to the Cluster under the given Endpoint, " +
                            "scoped to the associated fabric of the list containing the entry." +
                            "\n" +
                            "This list shall NOT be empty."

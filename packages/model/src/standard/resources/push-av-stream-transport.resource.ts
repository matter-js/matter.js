...
Resource.add({
    ...
    children: [
        {
            tag: "attribute", name: "FeatureMap", xref: "cluster§11.7.5",

            children: [
                {
                    tag: "field", name: "PERZONESENS", xref: "cluster§11.7.5.1",
                ...
                {
                    tag: "field", name: "METADATA", xref: "cluster§11.7.5.2",
        ...
        {
            tag: "attribute", name: "SupportedFormats", xref: "cluster§11.7.8.1",
        ...
        {
            tag: "attribute", name: "CurrentConnections", xref: "cluster§11.7.8.2",
        ...
        {
            tag: "event", name: "PushTransportBegin", xref: "cluster§11.7.10.1",
            ...
            children: [
                {
                    tag: "field", name: "ConnectionId", xref: "cluster§11.7.10.1.1",
                    details: "This field shall be a PushTransportConnectionID representing the push transport which started " +
                        "transmitting."
                },
                {
                    tag: "field", name: "TriggerType", xref: "cluster§11.7.10.1.2",
                    details: "This field shall represent the type of trigger which caused this event to be emitted."
                },
                {
                    tag: "field", name: "ActivationReason", xref: "cluster§11.7.10.1.3",
        ...
        {
            tag: "event", name: "PushTransportEnd", xref: "cluster§11.7.10.2",
            details: "This event shall indicate a push transport transmission has ended." +
                "\n" +
                "The data on this event shall contain the following information.",
            children: [{
                tag: "field", name: "ConnectionId", xref: "cluster§11.7.10.2.1",
        ...
        {
            tag: "command", name: "AllocatePushTransport", xref: "cluster§11.7.9.1",
            details: "This command shall allocate a transport and return a PushTransportConnectionID.",
            children: [{
                tag: "field", name: "TransportOptions", xref: "cluster§11.7.9.1.1",
                details: "This field shall represent the configuration options of the transport to be allocated."
            }]
        },

        {
            tag: "command", name: "AllocatePushTransportResponse", xref: "cluster§11.7.9.2",
            details: "This command shall be generated in response to a successful AllocatePushTransport command.",

            children: [{
                tag: "field", name: "TransportConfiguration", xref: "cluster§11.7.9.2.1",
                details: "This field shall be a TransportConfigurationStruct representing the newly allocated transport. If " +
                    "automatic stream selection was requested, the used Stream ID fields will be present in the " +
                    "TransportOptions field."
            }]
        },

        {
            tag: "command", name: "DeallocatePushTransport", xref: "cluster§11.7.9.3",
            details: "This command shall be generated to request the Node deallocates the specified transport.",
            children: [{
                tag: "field", name: "ConnectionId", xref: "cluster§11.7.9.3.1",
                details: "This field shall be a PushTransportConnectionID representing the allocated transport to deallocate."
            }]
        },

        {
            tag: "command", name: "ModifyPushTransport", xref: "cluster§11.7.9.4",
            details: "This command is used to request the Node modifies the configuration of the specified push transport.",

            children: [
                {
                    tag: "field", name: "ConnectionId", xref: "cluster§11.7.9.4.1",
                    details: "This field shall be a PushTransportConnectionID representing the transport to modify."
                },
                {
                    tag: "field", name: "TransportOptions", xref: "cluster§11.7.9.4.2",
        ...
        {
            tag: "command", name: "SetTransportStatus", xref: "cluster§11.7.9.5",
            ...
            children: [
                {
                    tag: "field", name: "ConnectionId", xref: "cluster§11.7.9.5.1",
                ...
                {
                    tag: "field", name: "TransportStatus", xref: "cluster§11.7.9.5.2",
        ...
        {
            tag: "command", name: "FindTransport", xref: "cluster§11.7.9.7",
            ...
            children: [
                {
                    ...
                    xref: "cluster§11.7.6.1.1",
                    details: "When set to this value, transport will only occur if ManuallyTriggerTransport is invoked."
                },

                {
                    tag: "field", name: "Motion", description: "Triggered via motion detection or command",
                    xref: "cluster§11.7.6.1.2",
        ...
        {
            tag: "datatype", name: "TransportStatusEnum", xref: "cluster§11.7.6.2",
            children: [
        ...
        {
            tag: "datatype", name: "ContainerFormatEnum", xref: "cluster§11.7.6.3",

            children: [{
                tag: "field", name: "Cmaf", description: "CMAF container format", xref: "cluster§11.7.6.3.1",
        ...
        {
            tag: "datatype", name: "IngestMethodsEnum", xref: "cluster§11.7.6.4",
            children: [{
                tag: "field", name: "CmafIngest", description: "CMAF ingestion format", xref: "cluster§11.7.6.4.1",
                details: "This value shall mean that CMAF Ingestion is utilized. See CMAF Ingestion for full details."
            }]
        },

        {
            tag: "datatype", name: "TriggerActivationReasonEnum", xref: "cluster§11.7.6.5",
            children: [
        ...
        {
            tag: "datatype", name: "SupportedFormatStruct", xref: "cluster§11.7.6.6",
        ...
        {
            tag: "datatype", name: "CMAFInterfaceEnum", xref: "cluster§11.7.6.7",
            details: "This type indicates the exact mode of CMAF that is in use.",

            children: [
                {
                    tag: "field", name: "Interface1", description: "CMAF Interface-1 Mode", xref: "cluster§11.7.6.7.1",
        ...
        {
            tag: "datatype", name: "CMAFContainerOptionsStruct", xref: "cluster§11.7.6.8",
            details: "This struct encodes options for configuration of the CMAF container format.",

            children: [
                {
                    tag: "field", name: "CmafInterface", xref: "cluster§11.7.6.8.1",
                ...
                {
                    tag: "field", name: "SegmentDuration", xref: "cluster§11.7.6.8.2",
                ...
                {
                    tag: "field", name: "ChunkDuration", xref: "cluster§11.7.6.8.3",
                ...
                {
                    tag: "field", name: "SessionGroup", xref: "cluster§11.7.6.8.4",
                    details: "This field shall identify the grouping semantic of the CMAF Session numbering between various CMAF " +
                        "transports on the same Fabric. See Session Grouping for more details."
                },
                {
                    tag: "field", name: "TrackName", xref: "cluster§11.7.6.8.5",
                    details: "This field shall identify the CMAF Track name value used inside the CMAF computed extended path " +
                        "fields portion of the CMAF POST_URL. See Track Naming for full details."
                },

                {
                    tag: "field", name: "CencKey", xref: "cluster§11.7.6.8.6",
                ...
                {
                    tag: "field", name: "CencKeyId", xref: "cluster§11.7.6.8.7",
                ...
                {
                    tag: "field", name: "MetadataEnabled", xref: "cluster§11.7.6.8.8",
                    ...
                    details: "This field, if present and true, indicates that AVMetadataStruct based Metadata tracks and boxes may " +
                        ...
                        "\n" +
                        "  - Use a single Track for time-synced data points as described in CMAF-Ingest Interface-1 Section " +
        ...
        {
            tag: "datatype", name: "ContainerOptionsStruct", xref: "cluster§11.7.6.9",
            details: "This struct encodes the specific container type options struct",

            children: [
                {
                    tag: "field", name: "ContainerType", xref: "cluster§11.7.6.9.1",
                    details: "This field shall indicate the container type chosen for this transport."
                },
                {
                    tag: "field", name: "CmafContainerOptions", xref: "cluster§11.7.6.9.2",
        ...
        {
            tag: "datatype", name: "TransportZoneOptionsStruct", xref: "cluster§11.7.6.10",
            details: "This struct encodes the options that configure the per Zone portion of a Trigger configuration.",

            children: [
                {
                    tag: "field", name: "Zone", xref: "cluster§11.7.6.10.1",
                ...
                {
                    tag: "field", name: "Sensitivity", xref: "cluster§11.7.6.10.2",
        ...
        {
            tag: "datatype", name: "TransportTriggerOptionsStruct", xref: "cluster§11.7.6.11",
            ...
            children: [
                {
                    tag: "field", name: "TriggerType", xref: "cluster§11.7.6.11.1",
                    details: "This field shall indicate the type of the transport trigger."
                },

                {
                    tag: "field", name: "MotionZones", xref: "cluster§11.7.6.11.2",
                ...
                {
                    tag: "field", name: "MotionSensitivity", xref: "cluster§11.7.6.11.3",
                ...
                {
                    tag: "field", name: "MotionTimeControl", xref: "cluster§11.7.6.11.4",
                ...
                {
                    tag: "field", name: "MaxPreRollLen", xref: "cluster§11.7.6.11.5",
        ...
        {
            tag: "datatype", name: "TransportMotionTriggerTimeControlStruct", xref: "cluster§11.7.6.12",
            ...
            details: "This struct is used to encode a set of values for controlling the lifecycle of a motion triggered " +
                ...
                "\n" +
                "However, if additional motion is detected during this period, the Node shall increase the " +
                "MotionDetectedDuration value by the AugmentationDuration value. This process may occur repeatedly " +
                "but after the first increase of MotionDetectedDuration the Node shall NOT increase the " +
                "MotionDetectedDuration value unless the previous MotionDetectedDuration has been exceeded by the " +
                "TimeSinceActivation." +
                "\n" +
                "If the TimeSinceActivation value exceeds the MaxDuration or MotionDetectedDuration value, the Node " +
                "shall stop detecting motion for this trigger for the period of the BlindDuration value." +
                "\n" +
            ...
            children: [
                {
                    tag: "field", name: "InitialDuration", xref: "cluster§11.7.6.12.1",
                    details: "This field shall indicate the initial duration in seconds after motion is first detected before the " +
                        "Node could emit a MotionStopped event."
                },
                {
                    tag: "field", name: "AugmentationDuration", xref: "cluster§11.7.6.12.2",
                ...
                {
                    tag: "field", name: "MaxDuration", xref: "cluster§11.7.6.12.3",
                    details: "This field shall indicate the maximum duration in seconds after initial motion detection that " +
                        "additional motion will be detected. The MaxDuration field value shall be greater or equal to the " +
                        "InitialDuration field value."
                },

                {
                    tag: "field", name: "BlindDuration", xref: "cluster§11.7.6.12.4",
        ...
        {
            tag: "datatype", name: "TransportOptionsStruct", xref: "cluster§11.7.6.13",
            details: "This encodes the options and configuration of a transport.",

            children: [
                {
                    tag: "field", name: "StreamUsage", xref: "cluster§11.7.6.13.1",
                    details: "This field contains the StreamUsageEnum of this transport."
                },

                {
                    tag: "field", name: "VideoStreamId", xref: "cluster§11.7.6.13.2",
                    ...
                    details: "This field shall have the following semantics:" +
                        ...
                        "\n" +
                        "  - If present and non-null, the specific video stream identified by the VideoStreamIDType is " +
                        "requested."
                },

                {
                    tag: "field", name: "AudioStreamId", xref: "cluster§11.7.6.13.3",
                    ...
                    details: "This field shall have the following semantics:" +
                        ...
                        "\n" +
                        "  - If present and non-null, the specific audio stream identified by the AudioStreamIDType is " +
                        "requested."
                },

                {
                    tag: "field", name: "TlsEndpointId", xref: "cluster§11.7.6.13.4",
                ...
                {
                    tag: "field", name: "Url", xref: "cluster§11.7.6.13.5",
                    ...
                    details: "This field shall be a valid string in RFC 3986 format representing the upload location. The field " +
                        ...
                        "specify the session, track, and segment names as these will be internally appended."
                },

                {
                    tag: "field", name: "TriggerOptions", xref: "cluster§11.7.6.13.6",
                    details: "This field shall be of type TransportTriggerOptionsStruct and represents the Trigger Type and its " +
                        "sub options."
                },
                {
                    tag: "field", name: "IngestMethod", xref: "cluster§11.7.6.13.7",
                    details: "This field shall be of type IngestMethodsEnum and represents the Ingest Method to be used."
                },
                {
                    tag: "field", name: "ContainerOptions", xref: "cluster§11.7.6.13.8",
                ...
                {
                    tag: "field", name: "ExpiryTime", xref: "cluster§11.7.6.13.9",
        ...
        {
            tag: "datatype", name: "PushTransportConnectionID", xref: "cluster§11.7.6.15",
        ...
        {
            tag: "datatype", name: "StatusCodeEnum", xref: "cluster§11.7.7.1",

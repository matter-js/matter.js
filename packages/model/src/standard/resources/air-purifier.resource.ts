...
Resource.add({
    ...
    children: [
        { tag: "requirement", name: "GroupcastListenerCond", xref: "device§9.3.5" },
        { tag: "requirement", name: "Identify", xref: "device§9.3.6" },
        { tag: "requirement", name: "Groups", xref: "device§9.3.6" },
        { tag: "requirement", name: "OnOff", xref: "device§9.3.6" },
        { tag: "requirement", name: "HepaFilterMonitoring", xref: "device§9.3.6" },
        { tag: "requirement", name: "ActivatedCarbonFilterMonitoring", xref: "device§9.3.6" },
        { tag: "requirement", name: "FanControl", xref: "device§9.3.6" },

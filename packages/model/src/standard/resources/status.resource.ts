...
Resource.add({
    ...
    children: [
        ...
        {
            tag: "field", name: "NotFound", description: "The indicated data field or entry could not be found",
            xref: "core§8.10.1"
        },
        {
        ...
        },
        {
            ...
            description: "The indicated event ID is not supported on the cluster instance", xref: "core§8.10.1"
        },
        {

    ...
    children: [
        {
            ...
            children: [{ tag: "requirement", name: "TriggerEffect", xref: "device§4.3.5" }]
        },
        { tag: "requirement", name: "Groups", xref: "device§4.3.4" },
        {
            tag: "requirement", name: "OnOff", xref: "device§4.3.4",
            children: [{ tag: "requirement", name: "LIGHTING", xref: "device§4.3.5" }]
        },

        {
            ...
            children: [
                ...
                { tag: "requirement", name: "LIGHTING", xref: "device§4.3.5" },
                { tag: "requirement", name: "CurrentLevel", xref: "device§4.3.5" },
                { tag: "requirement", name: "MinLevel", xref: "device§4.3.5" },
                { tag: "requirement", name: "MaxLevel", xref: "device§4.3.5" }
            ]
        },

        {
            tag: "requirement", name: "ScenesManagement", xref: "device§4.3.4",
            children: [{ tag: "requirement", name: "CopyScene", xref: "device§4.3.5" }]
        },

        {
            tag: "requirement", name: "ColorControl", xref: "device§4.3.4",
            children: [
                { tag: "requirement", name: "COLORTEMPERATURE", xref: "device§4.3.5" },
                { tag: "requirement", name: "RemainingTime", xref: "device§4.3.5" }
            ]
        },

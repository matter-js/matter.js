...
Resource.add({
    ...
    details: "A Dimmable Plug-In Unit is a device that provides power to another device that is plugged into it, " +
        ...
        "phase cutting." +
        "\n" +
        "The Section 5.4, “Mounted Dimmable Load Control” (added in Matter 1.4) has identical cluster " +
        "requirements as the Dimmable Plug-In Unit, and is marked as a superset of this device type (since " +
        "Matter 1.4.2). For devices intended to be mounted permanently, the Section 5.4, “Mounted Dimmable " +
        "Load Control” device type shall be used, with the Dimmable Plug-In Unit device type optionally added " +
        "to the DeviceTypeList of the Descriptor cluster in addition to the Mounted Dimmable Load Control " +

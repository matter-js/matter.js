...
export const NetworkInfrastructureManagerDt = DeviceType(
    ...
    Requirement({ name: "Ip", type: "Base.Ip", conformance: "M", element: "condition", location: "Root" }),
    Requirement({ name: "IPv4", type: "Base.IPv4", conformance: "M", element: "condition", location: "Root" }),
    Requirement({ name: "IPv6", type: "Base.IPv6", conformance: "M", element: "condition", location: "Root" }),
    Requirement({ name: "Ethernet", type: "Base.Ethernet", conformance: "M", element: "condition", location: "Root" }),
    Requirement({ name: "WiFi", type: "Base.WiFi", conformance: "M", element: "condition", location: "Root" }),
    Requirement({ name: "Thread", type: "Base.Thread", conformance: "M", element: "condition", location: "Root" }),

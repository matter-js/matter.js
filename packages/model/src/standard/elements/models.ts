...
export const AmbientContextSensing = new ClusterModel(definitions.AmbientContextSensing);
export const TemperatureAlarm = new ClusterModel(definitions.TemperatureAlarm);
...
export const CertificationTypeEnum = new DatatypeModel(definitions.CertificationTypeEnum);
...
export const IdentifiedSoundNs = new SemanticNamespaceModel(definitions.IdentifiedSoundNs);
export const IdentifiedObjectNs = new SemanticNamespaceModel(definitions.IdentifiedObjectNs);
export const IdentifiedHumanActivityNs = new SemanticNamespaceModel(definitions.IdentifiedHumanActivityNs);

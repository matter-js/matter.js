...
export const OccupancyBitmap = new DatatypeModel(definitions.OccupancyBitmap);
export const OccupancySensorTypeBitmap = new DatatypeModel(definitions.OccupancySensorTypeBitmap);
export const OccupancySensorTypeEnum = new DatatypeModel(definitions.OccupancySensorTypeEnum);
export const HoldTimeLimitsStruct = new DatatypeModel(definitions.HoldTimeLimitsStruct);
...
export const WebRtcSessionId = new DatatypeModel(definitions.WebRtcSessionId);
export const WebRtcEndReasonEnum = new DatatypeModel(definitions.WebRtcEndReasonEnum);
export const IceServerStruct = new DatatypeModel(definitions.IceServerStruct);
export const IceCandidateStruct = new DatatypeModel(definitions.IceCandidateStruct);
export const WebRtcSessionStruct = new DatatypeModel(definitions.WebRtcSessionStruct);

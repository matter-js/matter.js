...
export const IcdManagement = Cluster(
    ...
    Datatype(
        ...
        Field({ name: "PowerCycle", conformance: "M", constraint: "0" }),
        Field({ name: "SettingsMenu", conformance: "M", constraint: "1" }),
        Field({ name: "CustomInstruction", conformance: "M", constraint: "2" }),
        Field({ name: "DeviceManual", conformance: "M", constraint: "3" }),
        Field({ name: "ActuateSensor", conformance: "M", constraint: "4" }),
        Field({ name: "ActuateSensorSeconds", conformance: "M", constraint: "5" }),
        Field({ name: "ActuateSensorTimes", conformance: "M", constraint: "6" }),
        Field({ name: "ActuateSensorLightsBlink", conformance: "M", constraint: "7" }),
        Field({ name: "ResetButton", conformance: "M", constraint: "8" }),
        Field({ name: "ResetButtonLightsBlink", conformance: "M", constraint: "9" }),
        Field({ name: "ResetButtonSeconds", conformance: "M", constraint: "10" }),
        Field({ name: "ResetButtonTimes", conformance: "M", constraint: "11" }),
        Field({ name: "SetupButton", conformance: "M", constraint: "12" }),
        Field({ name: "SetupButtonSeconds", conformance: "M", constraint: "13" }),
        Field({ name: "SetupButtonLightsBlink", conformance: "M", constraint: "14" }),
        Field({ name: "SetupButtonTimes", conformance: "M", constraint: "15" }),
        Field({ name: "AppDefinedButton", conformance: "M", constraint: "16" })
    ),
